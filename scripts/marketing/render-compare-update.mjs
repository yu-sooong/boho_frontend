/**
 * 渲染「兩班對照・更版」社群短動畫
 * 用法：node scripts/marketing/render-compare-update.mjs
 *
 * 輸出：
 * - threads-compare-update.{png,webm,mp4}（1:1）
 * - stories-compare-update.{png,webm,mp4}（9:16）
 */
...
const jobs = [
  {
    file: 'poster-compare-update.html',
    png: 'threads-compare-update.png',
    webm: 'threads-compare-update.webm',
    mp4: 'threads-compare-update.mp4',
    width: 1080,
    height: 1080,
    waitMs: 2800,
    recordMs: 9200,
  ...
  {
    file: 'poster-compare-update-story.html',
    png: 'stories-compare-update.png',
    webm: 'stories-compare-update.webm',
    mp4: 'stories-compare-update.mp4',
    width: 1080,
    height: 1920,
    waitMs: 2800,
    recordMs: 9200,
...
console.log('文案／腳本 → scripts/marketing/COMPARE-UPDATE.md')
