/**
 * 渲染「新北／高雄即將上線」社群短動畫
 * 用法：node scripts/marketing/render-cities-launch.mjs
 *
 * 輸出：
 * - threads-cities-launch.{png,webm,mp4}（1:1）
 * - stories-cities-launch.{png,webm,mp4}（9:16）
 */
...
const jobs = [
  {
    file: 'poster-cities-launch.html',
    png: 'threads-cities-launch.png',
    webm: 'threads-cities-launch.webm',
    mp4: 'threads-cities-launch.mp4',
    width: 1080,
    height: 1080,
    waitMs: 2800,
    recordMs: 9200,
  ...
  {
    file: 'poster-cities-launch-story.html',
    png: 'stories-cities-launch.png',
    webm: 'stories-cities-launch.webm',
    mp4: 'stories-cities-launch.mp4',
    width: 1080,
    height: 1920,
    waitMs: 2800,
    recordMs: 9200,
...
console.log('文案／腳本 → scripts/marketing/CITIES-LAUNCH.md')
