...
export const REVIEW_POLICY = {
  ...
  points: [
    ...
    '請寫具體親身經驗。需要改進的回饋只要具體、不人身攻擊，一樣會刊出。',
    '廣告、人身攻擊、洩漏個資（如老師或小孩姓名）、道聽塗說會退件。',
    '我們不向補習班販售置頂或業配排序，也不以付費作為刪改評價的條件。',
    '業者目前無法在平台直接回應評價；此功能尚在規劃。若有異議，可透過「聯絡我們」提出。',
    '公開資料與公告來自主管機關；本平台僅加值呈現，評價為投稿者意見，不代表本平台保證或背書。',
  ],
  privacyNote:
